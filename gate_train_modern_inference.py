...
def main():
    ...
    # ============================================================================
    # Update these variables to match your specific ModernBERT training run
    RUN_NAME = "modern-0513-173" 
    MODEL_NAME = "ModernBERT"
    RUN_DATE = "0513"
    RUN_INDEX = 173
    CHECKPOINT_STEP = 50001 # Update to your actual checkpoint step
    ...
    try:
        ...
        config = {
            'data': {
                ...
                'test_files': ["processed_iterable_dataset_modern/test_50k.jsonl"] 
            },
            'loss': {
    ...
    # Initialize ModernBERT tokenizer dynamically
    bert_model_name = model_args.get("bert_model_name", "answerdotai/ModernBERT-base")
    ...
    # ===== DATASET SETUP =====``
    # ============================================================================
    # Use test_50k.jsonl from your processed_iterable_dataset_modern folder
    test_files = config['data'].get('test_files', ["processed_iterable_dataset_modern/test_50k.jsonl"])
    ...
    # ============================================================================
    train_time_counts = load_counter_data("time")
    train_time_counts.pop('-100', None)
    
    train_tag_counts = load_counter_data("tag")
    ...
    checkpoint_path = os.path.join("model_weight", "ModernBERT", f"{RUN_DATE}_{RUN_INDEX}_step{CHECKPOINT_STEP}.pt")
